...
#SBATCH --output=./outdir02/test.out
#SBATCH --error=./outdir02/test.err
#
#SBATCH --ntasks=1
#SBATCH --time=1440:00
...
mkdir ${JOBFS}/outdir02_${pulsar}_${Tfit}_${Nfit_min}
python ${JOBFS}/run_on_real_data_twocomp_bins.py --Nwalks 100 --Npoints 10000 --freqfile ${freqfile} --out_directory ${JOBFS}/outdir02_${pulsar}_${Tfit}_${Nfit_min} --tag ${tag}
mv ${JOBFS}/outdir02_${pulsar}_${Tfit}_${Nfit_min} ${output_location}
