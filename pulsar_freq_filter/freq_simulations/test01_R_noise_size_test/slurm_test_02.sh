...
#Run the program
python ${JOBFS}/ns_sim_random_vary_EM_only.py --R_in 1e-24 --R_out 1e-24 --Nobs 1000 --Tdays 1000 --out_directory ${JOBFS}/outdir02_$SLURM_ARRAY_TASK_ID --tag test_$SLURM_ARRAY_TASK_ID
