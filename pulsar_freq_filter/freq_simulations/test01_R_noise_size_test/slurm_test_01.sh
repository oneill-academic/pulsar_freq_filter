...
#Run the program
python ${JOBFS}/ns_sim_random_vary_EM_only.py --R_in 1e-30 --R_out 1e-30 --Nobs 1000 --Tdays 1000 --out_directory ${JOBFS}/outdir01_$SLURM_ARRAY_TASK_ID --tag test_$SLURM_ARRAY_TASK_ID
